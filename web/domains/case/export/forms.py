...
class NewExportApplicationForm(ModelEditForm):
...
class CertManufactureForm(ModelEditForm):
    class Meta:
    ...
    def __init__(self, request, *args, **kwargs):
        ...
        self.fields["contact"].initial = request.user

        # FIXME: change contact.queryset to be just users who should be listed
